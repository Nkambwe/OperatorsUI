<%-- 
    Document   : employer_individual
    Created on : May 16, 2025, 5:55:22 AM
    Author     : Macjohnan
--%>

<%@page import="com.google.gson.JsonObject"%>
<%@page import="com.google.gson.JsonSyntaxException"%>
<%@page import="com.kram.operators.dtos.IndividualEmployer"%>
...
<%
    ...
    try {
        ...
        responseObj = controller.getEmployerInfo(employerId, 1); 

        IndividualEmployer data = (IndividualEmployer)responseObj.getData();
