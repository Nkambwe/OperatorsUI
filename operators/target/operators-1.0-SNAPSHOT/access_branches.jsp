<%-- 
    Document   : access_branches
    Created on : Feb 17, 2025, 4:33:47 AM
    Author     : Macjohnan
--%>
...
<%
    ...
    //set current page
    session.setAttribute(AppConstants.CURRENT_PAGE, "BRANCHES_PAGE");
    ...
    ApplicationLog.saveLog("Session Kin :: " + theme_name, "BRANCHES_PAGE");
    ...
    ApplicationLog.saveLog("Session Color :: " + theme_clr, "BRANCHES_PAGE");
    
    String img_clr = theme_clr; 
    ApplicationLog.saveLog("Image Color :: " + img_clr, "BRANCHES_PAGE");
    ...
    if(theme != null){
        ...
        ApplicationLog.saveLog("Saved Skin :: " + theme_name, "BRANCHES_PAGE");
        theme_clr = theme.getColor();
        session.setAttribute(AppConstants.THEME_COLOR, theme_clr);
        ApplicationLog.saveLog("Saved Color :: " + theme_clr, "BRANCHES_PAGE");
        session.setAttribute(AppConstants.IMG_COLOR, theme_clr);
        ApplicationLog.saveLog("Image Color :: " + theme_clr, "BRANCHES_PAGE");
    } else {
        //current theme color
    ...
    ApplicationLog.saveLog("Current Theme :: " + theme_color, "BRANCHES_PAGE");
%>
<!DOCTYPE html>
<html>
    <head>
